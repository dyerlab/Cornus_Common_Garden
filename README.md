...
| `supplemental.md` | Appendix S1 — statistical model structure, variance decomposition, diagnostics |
| `data/*.csv` | Input data (see **Data files** below) |
| `media/` | Manuscript figures (`fig_survival`, `fig_blups`) and per-model diagnostic panels under `diagnostics/` |
